...
import com.datu.fanli.bean.ProductInfoExample.Criteria;
import com.datu.fanli.bean.ProductInfoExample.Criterion;
...
public class ProductInfoSqlProvider {
    ...
    public String countByExample(ProductInfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("pms_product_info");
    ...
    public String deleteByExample(ProductInfoExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("pms_product_info");
        applyWhere(sql, example, false);
        return sql.toString();
    }
    ...
    public String insertSelective(ProductInfo record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("pms_product_info");
