...
import com.datu.fanli.bean.ManagerExample.Criteria;
import com.datu.fanli.bean.ManagerExample.Criterion;
...
public class ManagerSqlProvider {
    ...
    public String countByExample(ManagerExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("ums_manager");
